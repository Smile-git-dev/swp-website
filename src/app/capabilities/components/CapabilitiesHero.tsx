        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
          ...
          <div>
            <p className="text-muted-foreground text-base leading-relaxed">
              ตั้งแต่การออกแบบแม่พิมพ์ไปจนถึงการผลิตจริง SWP ให้บริการครบวงจรด้วยคุณภาพที่สม่ำเสมอ รวดเร็ว และยืดหยุ่น ด้วยเครื่องจักร Injection Molding ขนาด 80–650 ตัน และทีมวิศวกรผู้เชี่ยวชาญ เราพร้อมรองรับทุกความต้องการของลูกค้า ตั้งแต่ Prototype จนถึงการผลิตจำนวนมาก
            </p>
          </div>
        </div>
      </div>
